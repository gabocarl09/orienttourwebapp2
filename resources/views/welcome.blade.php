        ...
        <div class="row justify-content-between">
            <div class="col-lg-6">
                <div class="intro-excerpt">
                    ...
                    <p class="mb-4">Descubre la esencia de nuestra cultura a través de nuestras artesanías y
...
<div class="landingSect">
    <div class="landingSect_info">
        ...
        <div class=" landingSect_info_val">
            ...
            <p class="">Somos la primera plataroma en ofrecerte servicios de venta de productos artesanales
                precolombinos de la ciudad creativa San Juan de Oriente-Nicaragua, productos realizados por artesanos
                culturalmente profesionales. </p>
        </div>
        ...
        <div class="row justify-content-between">
            ...
            <div class="col-lg-5 ps-lg-5 landingSect2">
                ...
                <ul class="list-unstyled my-4 list-style">
                    <li>Los mejores productos precolombinos de la ciudad creativa San Juan del Oriente con tan solo unos
                        clicks pueden ser tuyos.</li>
                    <li>Los mejores productos precolombinos de la ciudad creativa San Juan del Oriente con tan solo unos
                        clicks pueden ser tuyos.</li>
                    <li>Los mejores productos precolombinos de la ciudad creativa San Juan del Oriente con tan solo unos
                        clicks pueden ser tuyos.</li>
...
<footer class="footer-section" style="background-color: #f85959b8">
    <div class="container relative">
        ...
        <div class="row g-5 mb-5">
            <div class="col-lg-4">
                <div class="mb-4 footer-logo-wrap"><a href="#" class="footer-logo">ORIENTTOUR<span>.</span></a>
                </div>
        ...
        <div class="border-top copyright">
            <div class="row pt-4">
                <div class="col-lg-6">
                    <p class="mb-2 text-center text-lg-start">Copyright &copy;. Todos los derechos reservados. &mdash;
                        Orienttour Distribuido por Bytewebnet </p>
                </div>
            </div>
        </div>
